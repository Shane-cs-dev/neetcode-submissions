class Solution:
    def findInMountainArray(self, target: int, mountainArr: 'MountainArray') -> int:
        ...
        while left < right:
            ...
            left_val, mid_val, right_val = mountainArr.get(mid - 1), mountainArr.get(mid), mountainArr.get(mid + 1)
            ...
            if left_val < mid_val < right_val:
                ...
                peak_idx = mid
                print(f"This is peak index: {peak_idx}, value: {mountainArr.get(peak_idx)}")
                break
        ...
        while left <= right:
            ...
            if mid_val == target:
                ...
                right = mid - 1
        print(f"This is left side: {left}, value: {mountainArr.get(left)}")
